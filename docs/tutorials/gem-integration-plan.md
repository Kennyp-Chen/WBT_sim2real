...
| 2026-08-14 | GEM-007/009 | `Go.mp3` 17.345 s recorded-audio demo | `gem_audio_motion_stream.py` -> SMPL-X global mesh render -> G1/PiPlus GMR -> BFM-Zero and SONIC ZMQ recorders -> wall-clock correction and three-panel audio mux | `outputs/gem_retarget/music_go/final/go_human_{g1_reference_bfmzero,piplus_reference_bfmzero,g1_reference_sonic}_with_audio.mp4` | generated 521 human frames at 30 Hz and 868 robot reference frames at 50 Hz; all retargets had zero joint-limit violations; all three policies remained upright at 2/8/15 s; final layout is human / robot reference / policy, all files are 1920x720 and 17.345 s with AAC audio; G1 BFM-Zero and SONIC are 30 fps, PiPlus is 20 fps to preserve real-time synchronization |
